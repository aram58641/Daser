...
## align-items
 ճկուն տարրերի դասավորությունը խաչաձև առանցքի վրա (y առանցքը, եթե՝ x առանցքը flex-direction: column): Ընտրեք start, end, center, baselineկամ stretch(զննարկիչի լռելյայն):
## Տնային աշխատանք 2
