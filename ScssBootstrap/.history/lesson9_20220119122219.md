...
## Փոխեք որոշակի ճկուն տարրերի տեսողական կարգը մի քանի order Մենք տրամադրում ենք միայն տարրը առաջինը կամ վերջինը պատրաստելու տարբերակներ, ինչպես նաև վերակայում DOM պատվերն օգտագործելու համար: Քանի որ orderընդունում է ցանկացած ամբողջ արժեք (օրինակ, 5), ավելացրեք հատուկ CSS ցանկացած լրացուցիչ արժեքի համար, որն անհրաժեշտ է:
## Տնային աշխատանք 2
