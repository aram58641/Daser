...
bootstrap - ում կոճակները ստեղծվում ենհետևյալ կերպով։
Bootstrap-ը ներառում է մի քանի նախապես սահմանված կոճակների ոճեր, որոնցից յուրաքանչյուրը ծառայում է իր իմաստային նպատակին, ավելի շատ վերահսկելու համար մի քանի հավելյալներ:
Օրինակ՝
