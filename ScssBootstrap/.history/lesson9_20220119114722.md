...
## align-items
ֆլեքսբոքս կոնտեյներների կոմունալ ծառայությունները՝ փոխելու ճկուն տարրերի դասավորությունը խաչաձև առանցքի վրա (սկսելու համար նախատեսված y առանցքը, եթե՝ x առանցքը flex-direction: column): Ընտրեք start, end, center, baselineկամ stretch(զննարկիչի լռելյայն):
## Տնային աշխատանք 2
