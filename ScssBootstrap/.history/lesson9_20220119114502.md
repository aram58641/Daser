...
Օգտագործեք justify-contentֆլեքսբոքս կոնտեյներների կոմունալ ծրագրերը՝ ֆլեքս տարրերի դասավորվածությունը հիմնական առանցքի վրա փոխելու համար (սկսելու x առանցքը, y առանցքը, եթե flex-direction: column): Ընտրեք start(զննարկիչի լռելյայն), end, center, betweenկամ around:
## Տնային աշխատանք 2
